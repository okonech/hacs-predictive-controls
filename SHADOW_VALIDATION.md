...
**Not yet collected.** Automated tests and synthetic benchmarks cannot establish real sensor ordering, entity flapping, Home Assistant event-loop contention, or household movement accuracy. This evidence is an external rollout gate for 0.1.17.

## Preconditions

- Run the exact 0.1.17 release-candidate code and record its commit SHA.
